...
if __name__ == "__main__":
    API_URL = "https://api.polygon.io/v3/reference/tickers?type=CS&market=stocks&active=true&order=asc&limit=1000&sort=ticker&apiKey=tInlOScwTLtPvb9rzaQXVMaS_eWvtBb7"
